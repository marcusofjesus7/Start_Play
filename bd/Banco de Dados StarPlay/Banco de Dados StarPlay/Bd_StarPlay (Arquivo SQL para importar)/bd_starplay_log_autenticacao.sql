CREATE DATABASE  IF NOT EXISTS `bd_starplay` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `bd_starplay`;
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: bd_starplay
-- ------------------------------------------------------
...
CREATE TABLE `log_autenticacao` (
  ...
  `sucessologin` tinyint(1) NOT NULL,
  `detalhes` text NOT NULL,
  PRIMARY KEY (`id_log`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `log_autenticacao_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
...
-- Dump completed on 2025-05-30 22:29:54
